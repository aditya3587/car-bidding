                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      <h4 class="m-t-0 header-title mb-4">Add Evaluator</h4>

                                      <form autocomplete="off" name="myform" method="post" action="sv_evaluator.php">
                                            <div class="form-group">
                                                <label for="name">Name<span class="text-danger">*</span></label>
                                                <input type="text" name="name" parsley-trigger="change" required
                                                        placeholder="Enter name" class="form-control" id="name" maxlength="30">
                                            ...
                                            <div class="form-group text-right m-b-0">
                                              <input type="submit" class="btn btn-primary" name="submit" value="Add Evaluator">
                                            </div>
