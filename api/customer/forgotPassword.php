...
include '../../PHPMailerAutoload.php';
 ...
 function forgot_password(){
    ...
    $sqlMerchantsList = "select * from customers where emailId='".$email."' and (userType='d' or userType='c') ";
 ...
 function resetPassword(){
    ...
    $sqlMerchantsList = "select * from customers where emailId='".$email."' and password= '".$password."' and (userType='d' or userType='c')";
