                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      <h4 class="m-t-0 header-title mb-4">Edit Approver</h4>
                                          ...
                                          <input type="hidden" name="hiddenId" value="<?php echo $id; ?>" required>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" parsley-trigger="change" required
                                                        placeholder="Enter name" class="form-control" id="name" value="<?php echo $row['name']; ?>">
                                            ...
                                            <div class="form-group text-right m-b-0">
                                              <input type="submit" class="btn btn-primary" name="submit" value="Edit Approver">
                                            </div>
