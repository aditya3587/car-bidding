                          ...
                          <div class="col-lg-12">
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      <form autocomplete="off" name="myform" method="post" action="sv_approver.php">
                                            <div class="form-group">
                                                <label for="name">Name<span class="text-danger">*</span></label>
                                                <input type="text" name="name" parsley-trigger="change" required
                                                        placeholder="Enter name" class="form-control" id="name" maxlenght="30">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="email" name="emailId" parsley-trigger="change" required
                                                            placeholder="Enter email id" class="form-control" id="emailId">
                                                </div>
                                                <div class="form-group col-md-6">
                                                  <label for="tel">Contact no<span class="text-danger">*</span></label>
                                                  <input type="text" name="contactNo" parsley-trigger="change" required
                                                          placeholder="Enter contact no" class="form-control" id="contactNo" maxlength="10">
                                                           <small><font color="#99A3AE">Enter 10 digit mobile number</font></small>
                                                </div>
                                            </div>
                                            <div class="form-group text-right m-b-0">
                                              <input type="submit" class="btn btn-primary" name="submit" value="Add Approver">
                                            </div>
